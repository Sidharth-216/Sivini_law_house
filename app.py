...
def homepage():
    if request.method == 'POST':
        ...
        try:
            ...
            """
            try:
                send_email(official_email, subject_official, body_official)#function call
...
def chatbot():
    if request.method == 'POST':
        ...
        try:
            # Correct usage of the updated lamla API
...
def email_send():
    if request.method == 'POST':
        ...
        try:
            # Use the existing send_email function for sending emails
